...
def get_precision_recall_f1(G_true, G_pred, filter_non_terminal=None):
    ...
    m_pred = get_multiset_ast(G_pred, filter_non_terminal)

    intersection = [n for n in m_pred if n in m_true]
    ...
    return prec, rec, f1, m_pred, m_true, intersection
